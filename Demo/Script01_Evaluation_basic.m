...
model.fmatrix = 'OPNMF'; % choose a model ('OPNMF', 'MLE', 'PAF', 'PCA'; default --> 'OPNMF')
...
CV.n = 100; % choose the CV number (default --> CV.n = 1000)
...
% Display the model pre-trained on HCP.

clearvars -except parameter base_dir
load(fullfile(base_dir,'Model','Model_NEO_FFI_60items_HCP_DYA.mat')); % load HCP-based model

plot_fmatrix(Model,[],[],[],parameter); % display figures based on HCP data  