...
%% -------------------------------------------------------------------------------------------------------------------------------
%% Input
%  (1) pos_data: N of items * K of variants matrix
%                  <specify the matrx of transformation rules for the path, 
%                   such as [1 2], which represents a transition from position 1 to position 2>
...
%  (8) category_spacing: intervals of n units between categories (default = 1)
%% Output
